...
t() (
  PREVIEW_CMD='batcat --style=header,grid --color=always --line-range=:500 {} || head -n 100 {}'
  ...
  fdfind . --type f -L --hidden --exclude .git | \
    fzf --ansi --multi \
        --preview "$PREVIEW_CMD" \
        --preview-window=right:60%:wrap \
        --bind "enter:become:$SELECTOR" \
        --bind "ctrl-o:execute:$SELECTOR" \
